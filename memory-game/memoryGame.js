...
let arrlink = [{ link: 'monkey.jpeg', id: 1 }, { link: 'penguin.jpeg', id: 2 }, { link: 'giraffe.jpeg', id: 3}, { link: 'fish.jpeg', id: 4 }, { link: 'fish.jpeg', id: 5 }, { link: 'giraffe.jpeg', id: 6 },  { link: 'penguin.jpeg', id: 7 },{ link: 'monkey.jpeg', id: 8}]
...
card.forEach((elem) => 
{
  elem.addEventListener('click', (event) => 
  {
    if (count % 2 == 0) {
      ...
      console.log("id of count 1:", first)
    }
    else {
      second = elem.getAttribute('id')
      console.log("id of count 2:", second)
    }
    count++
    console.log(count);
    arrlink.forEach((elem) => {
      if (elem.id == first) {
        firstsrc = elem.link;
        console.log("link1:", firstsrc)
      }
      if (elem.id == second) {
        secondsrc = elem.link
        console.log("link2:", secondsrc)
      }
    })
